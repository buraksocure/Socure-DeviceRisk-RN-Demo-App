...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-device-risk/react_native_device_risk.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/DeviceRisk/DeviceRisk.framework"
fi
